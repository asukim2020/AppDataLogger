package kr.co.greentech.dataloggerapp.fragment.measure.bluetooth;
...
import kr.co.greentech.dataloggerapp.util.Constants;
...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL)
                ...
                .setOngoing(true)
                .addAction(new NotificationCompat.Action(R.drawable.ic_clear_white_24, "Disconnect", disconnectPendingIntent));
